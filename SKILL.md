...
| Auction history, past sales or historical auction revenue | [Bounded history helper](references/auction-history.md): `history.py license` or `history.py charter`, optional day filter and finite block scope; license rounds remain separate by deployment generation |
