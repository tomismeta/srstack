...
This coverage is not a whole-site audit. [Updates](updates.md) routes current topic questions; [research workflow](research-workflow.md) describes scoped evidence gathering, with unsigned preparation and nonbroadcast simulation governed by [execution](execution.md).
