...
VERSION = "0.1.3"
SCRIPT_FILES = {"scripts/scenario.py", "scripts/snapshot.py", "scripts/price.py", "scripts/verify.py"}
...
def make_manifest(files):
    return {
        ...
        "scope": "Runtime knowledge, fixed public readers, scenario planner and installation verifier; excludes manifest, repository maintenance, CI, Git metadata, and build/cache artifacts",
